...
- **Contract-bound traces** - Writes attempt-aware normalized trace evidence and identity-bound closure evidence carrying the exact contract and materialization-plan digests, then assesses controls and the declared run specification separately before rendering.
